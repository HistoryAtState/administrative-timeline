...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" queryBinding="xslt3">
    ...
    <xsl:function xmlns:functx="http://www.functx.com" as="xs:integer?" name="functx:days-in-month">
    ...
    <xsl:function xmlns:functx="http://www.functx.com" as="xs:boolean" name="functx:is-leap-year">
        <xsl:param as="xs:anyAtomicType?" name="date"/>
